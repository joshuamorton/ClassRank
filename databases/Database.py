...
if __name__ == "__main__":
    ...
    database.changeOpinion("one", "CS1331", 1)
    database.changeOpinion("one", "CS1332", 1)
    database.changeOpinion("one", "CS1333", 1)
    database.changeOpinion("one", "CS1334", 1)
    database.changeOpinion("one", "CS1335", 1)
    database.changeOpinion("two", "CS1331", 2)
    database.changeOpinion("two", "CS1332", 2)
    database.changeOpinion("two", "CS1333", 2)
    database.changeOpinion("two", "CS1334", 2)
    database.changeOpinion("two", "CS1335", None)
    database.changeOpinion("three", "CS1331", 2)
    database.changeOpinion("three", "CS1332", 2)
    database.changeOpinion("three", "CS1333", 2)
    database.changeOpinion("three", "CS1334", 2)
    database.changeOpinion("three", "CS1335", 2)
    database.changeOpinion("four", "CS1331", 1)
